...
serve(async (req) => {
  ...
  try {
    ...
    // IMPORTANT: Use homepage (not /carrello/) because WooCommerce processes add-to-cart
    // parameters on any page and then can auto-redirect to cart (if configured in WooCommerce settings)
