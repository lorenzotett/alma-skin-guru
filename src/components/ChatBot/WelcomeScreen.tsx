...
export const WelcomeScreen = ({ onStart }: WelcomeScreenProps) => {
  return (
    <div className="min-h-screen flex items-center justify-center p-3 sm:p-4 bg-[#9a4a13] relative overflow-hidden">
      ...
      <Card className="max-w-3xl w-full p-6 sm:p-8 md:p-10 lg:p-12 text-center space-y-6 sm:space-y-8 shadow-2xl bg-[#9a4a13] backdrop-blur-xl border-white/20 relative z-10 animate-fade-in">
        {/* Logo */}
        ...
        <div className="space-y-3 sm:space-y-4 px-2">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Analisi Pelle AI
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl font-semibold text-white/90 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            by Alma Natural Beauty
          </p>
          <p className="text-sm sm:text-base md:text-lg text-white/80 max-w-2xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 py-4 sm:py-6 animate-fade-in" style={{ animationDelay: '0.5s' }}>
          <div className="flex flex-col items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-primary/10 to-transparent hover:from-primary/20 transition-all hover:scale-105">
            ...
            <div className="text-center">
              <p className="font-bold text-sm sm:text-base text-white">Analisi AI</p>
              <p className="text-xs text-white/70">Tecnologia avanzata</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-accent/10 to-transparent hover:from-accent/20 transition-all hover:scale-105">
            ...
            <div className="text-center">
              <p className="font-bold text-sm sm:text-base text-white">Consulenza AI</p>
              <p className="text-xs text-white/70">Risposte immediate</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-primary/10 to-transparent hover:from-primary/20 transition-all hover:scale-105">
            ...
            <div className="text-center">
              <p className="font-bold text-sm sm:text-base text-white">Prodotti Naturali</p>
              <p className="text-xs text-white/70">Made in Italy</p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-4 sm:pt-6 animate-fade-in" style={{ animationDelay: '0.6s' }}>
          <Button 
            onClick={onStart}
            size="lg"
            className="text-base sm:text-lg px-8 py-6 sm:px-10 sm:py-7 bg-white text-[#9a4a13] hover:bg-white/90 shadow-xl hover:shadow-2xl transition-all hover:scale-105 w-full sm:w-auto rounded-full font-bold"
          >
        ...
        <div className="pt-4 animate-fade-in" style={{ animationDelay: '0.7s' }}>
          <div className="inline-block px-6 py-3 bg-white/20 border border-white/30 rounded-full">
        ...
        {/* Trust badges */}
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 pt-4 text-xs sm:text-sm text-white/80 animate-fade-in" style={{ animationDelay: '0.8s' }}>
